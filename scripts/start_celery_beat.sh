#!/bin/bash
# Production startup script for Celery Beat scheduler
# This script starts the Celery Beat process for scheduled tasks
...
# Check Redis connection (required for Celery Beat)
...
echo "Scheduler is ready to execute scheduled tasks."

exec celery -A crm_backend beat \
    --loglevel=info \
