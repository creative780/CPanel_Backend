@echo off
REM Start Celery Beat scheduler for periodic tasks (scheduled reports, etc.)
REM This should be run in a separate terminal from the main server
...
echo.
echo Starting Celery Beat scheduler...
echo This will check for scheduled reports every hour
echo.
echo Press Ctrl+C to stop
echo.

REM Start Celery Beat
python -m celery -A crm_backend beat -l info
